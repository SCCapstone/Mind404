        ...
        <View style={styles.profileDescriptionWrapper}>
          <View>
            <View style={{flexDirection: 'row', alignContent: 'center', alignItems: "center"}}>
              <Text style={{fontSize: 20, fontWeight: 'bold', color: 'black'}}>Your Rating: </Text>
              <Text style={{fontSize: 24, fontWeight: "bold", color: "green", fontStyle: 'italic', }}>{providerData.avgRating}</Text>
            </View>
